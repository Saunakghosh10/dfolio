...
import profile from "../../public/FOLIO_FINAL.png";
    ...
    >
      ...
      <div className="absolute top-10 flex justify-between sm:w-[90%] lg:max-w-[1440px]">
        ...
        <div className="flex gap-10 text-[#e4ded7] sm:gap-12 md:gap-14 lg:gap-14">
          ...
          <Link
            href="https://contra.com/saunak_ghosh_iqn20ur0?utm_campaign=social_sharing&utm_medium=independent_share&utm_source=copy_link"
            target="_blank"
      ...
      >
        ...
        >
          <p className="z-50 text-center text-[16px] font-medium text-[#e4ded7] md:text-[20px] lg:text-left">
            Full Stack Engineer and Web Designer,
            {/* prev at{" "} */}
            {/* <Link
        ...
        >
          <p className="text-right text-[16px] font-semibold text-[#e4ded7] md:text-[20px]">
            Focused on interfaces and experiences, working remotely from Kolkata,India.
          </p>
        </motion.div>
      </div>
    </motion.section>
